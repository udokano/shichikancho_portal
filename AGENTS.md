...
>
> 詳細: `Codex.local.md` / `~/.Codex/projects/-Users-okanoyusuke/memory/feedback_sichikenchou_no_acf_php.md` / `project_sichikenchou_acf_sync.md`
